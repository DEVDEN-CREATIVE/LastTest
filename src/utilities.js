...
// Drawing function
export const drawHand = (predictions, ctx,ring_btn1,ring_btn2,ring_btn3,brclet_btn1,brclet_btn2,ring,wrist) => 
{
  ...
  if (predictions.length > 0) 
  {
    ...
    predictions.forEach((prediction) => {
      ...
      {
        ring.setAttribute('src','https://ashish7777777.github.io/Ring/ring2.png');
      };
      ring_btn3.onclick=function ChangeSrc3()
      {
        ring.setAttribute('src','https://ashish7777777.github.io/Ring/ring3.png');
      };
